...
Cube::Cube() {
	...
	std::cout << "Test! -><-";
		...
		// top face 
		{{-1.0f,  1.0f,  1.0},  {0.0f, 0.0f, 1.0f, 0.5f}, {0.0f, 0.0f}},
		{{1.0f,  1.0f,  1.0},   {0.0f, 0.0f, 1.0f, 0.5f}, {1.0f, 0.0f}},
		{{-1.0f,  1.0f, -1.0},  {0.0f, 0.0f, 1.0f, 0.5f}, {0.0f, 1.0f}},
		{{1.0f,  1.0f, -1.0},   {0.0f, 0.0f, 1.0f, 0.5f}, {1.0f, 1.0f}},
		// bottom face 
